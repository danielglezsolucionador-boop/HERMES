...
class Settings(BaseSettings):
    ...
    EXECUTION_SESSION_ENABLED: bool = True
    EXECUTION_SESSION_MAX_ACTIVE: int = 1
    EXECUTION_SESSION_MAX_LOG_ENTRIES: int = 100
    ...
    ORCHESTRATION_MAX_ACTIVE: int = 1
    ORCHESTRATION_MAX_DEPENDENCIES: int = 10
    ORCHESTRATION_MAX_DEPENDENCY_CHAIN: int = 10
